  ...
  const steps = [
    {
      ...
      description:
        "Conoce nuestras instalaciones y metodología con una visita guiada personalizada.",
      duration: "1 mañana",
    },
    {
      icon: FileText,
      title: "2. Solicitud y Documentación",
      description:
        "Llena el formulario en línea y sube los documentos básicos (partida de nacimiento, últimas libretas de calificaciones).",
      duration: "1-2 días",
    },
    {
      icon: Users,
      title: "3. Entrevista Familiar",
      description:
        "Una conversación con el departamento de consejería estudiantil (DECE) para conocer a la familia y al estudiante.",
    ...
    },
    {
      ...
      description:
        "Pruebas académicas y psicopedagógicas adaptadas al nivel de ingreso del aspirante.",
      duration: "1 mañana",
    },
    {
      icon: DollarSign,
      title: "5. Reserva tu cupo",
      description:
        "Reserva el cupo con un pago inicial de $35, este valor se descontará despues del total de la matrícula.",
      duration: "1 día",
    },
    {
      icon: UserRoundCheck,
      ...
      description:
        "Una vez admitido, recibirás la carta de aceptación y los pasos para el pago de matrícula.",
      duration: "Inmediato",
    },
  ];
      ...
      <div className="bg-slate-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center max-w-3xl">
          ...
          <p className="text-xl text-slate-300">
            Únete a nuestra comunidad educativa. Buscamos familias comprometidas
            con una educación innovadora y humana.
          </p>
        </div>
      </div>
        ...
        <Section>
          ...
          <div className="mt-16 text-center">
            <Button
              asChild
              size="lg"
              className="h-14 px-10 text-lg shadow-xl hover:scale-105 transition-transform"
            >
              <a
                href="https://forms.office.com/pages/responsepage.aspx?id=LSpVclrLNEqVSSMxlmm-e0iz0eZ5WvhNnCIIa5qJUsdUQ1E2OUNHR1FFTlpINVRZN1pFQUw1RFRORy4u&route=shorturl"
                target="_blank"
